const URL = "https://fapi.coinglass.com/api/coin/v2/info?symbol=XAU";
...
async function fetchOnce() {
  ...
  try {
    ...
    const line =
      ...
      `prev=${formatNumber(previousPrice, 2)} ` +
      `tick=${tickChangeText} ` +
...
console.log("Starting live fetch (every 1s). Press Ctrl+C to stop.");
void tick();
