...
const LIVE_SPREAD_MAX_BPS_BY_MARKET_SYMBOL = Object.fromEntries(
  SYMBOLS.map((symbol) => [String(MARKET_SYMBOLS[symbol]).toUpperCase(), LIVE_SPREAD_MAX_BPS_BY_SYMBOL[symbol] ?? LIVE_SPREAD_MAX_BPS_DEFAULT]),
)
